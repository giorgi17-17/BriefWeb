...
router.post("/evaluate-answer", async (req, res) => {
  const {
    ...
    modelAnswer,
    userAnswer,
    language,             // optional override (e.g., "Georgian" | "English")
    weights,              // optional { accuracy?:40, completeness?:30, understanding?:20, clarity?:10 }
    strict = true,        // optional strictness toggle
  } = req.body || {};
  ...
  try {
    const evaluation = await evaluateOpenEndedAnswer(questionText, modelAnswer, userAnswer, {
